...
export const ENERGY_TABLE4: EnergyTable4Row[] = [
  { emp_min: 1, emp_max: 15, low: 4.0, mid: 6.0, high: 7.0 },
...
export const ENERGY_TABLE5: EnergyTable5Row[] = [
  { emp_min: 1, emp_max: 15, mon_low: 1.5, recert_low: 3.0, mon_mid: 2.0, recert_mid: 4.0, mon_high: 2.5, recert_high: 5.0 },
  { emp_min: 16, emp_max: 25, mon_low: 2.0, recert_low: 3.5, mon_mid: 2.5, recert_mid: 5.0, mon_high: 3.0, recert_high: 6.0 },
  { emp_min: 26, emp_max: 65, mon_low: 2.5, recert_low: 5.0, mon_mid: 3.0, recert_mid: 6.0, mon_high: 3.5, recert_high: 7.0 },
  { emp_min: 66, emp_max: 85, mon_low: 3.0, recert_low: 6.0, mon_mid: 3.5, recert_mid: 6.5, mon_high: 4.0, recert_high: 8.5 },
  { emp_min: 86, emp_max: 175, mon_low: 3.0, recert_low: 6.0, mon_mid: 4.0, recert_mid: 7.5, mon_high: 4.0, recert_high: 8.5 },
  { emp_min: 176, emp_max: 275, mon_low: 3.0, recert_low: 6.0, mon_mid: 4.0, recert_mid: 8.0, mon_high: 4.5, recert_high: 9.5 },
  { emp_min: 276, emp_max: 425, mon_low: 3.5, recert_low: 7.0, mon_mid: 4.5, recert_mid: 9.0, mon_high: 5.0, recert_high: 11.0 },
  { emp_min: 426, emp_max: 625, mon_low: 3.5, recert_low: 7.0, mon_mid: 4.5, recert_mid: 9.0, mon_high: 5.5, recert_high: 11.0 },
  { emp_min: 626, emp_max: 875, mon_low: 4.0, recert_low: 7.5, mon_mid: 5.0, recert_mid: 9.5, mon_high: 5.5, recert_high: 12.0 },
  { emp_min: 876, emp_max: 1175, mon_low: 4.5, recert_low: 9.0, mon_mid: 5.5, recert_mid: 11.0, mon_high: 6.0, recert_high: 12.5 },
  { emp_min: 1176, emp_max: 1550, mon_low: 5.0, recert_low: 9.5, mon_mid: 6.0, recert_mid: 11.5, mon_high: 6.5, recert_high: 13.0 },
  { emp_min: 1551, emp_max: 2025, mon_low: 5.0, recert_low: 10.0, mon_mid: 6.0, recert_mid: 12.0, mon_high: 7.0, recert_high: 13.5 },
  { emp_min: 2026, emp_max: 2675, mon_low: 5.5, recert_low: 11.0, mon_mid: 6.5, recert_mid: 13.0, mon_high: 7.0, recert_high: 14.0 },
  { emp_min: 2676, emp_max: 3450, mon_low: 6.0, recert_low: 11.5, mon_mid: 7.0, recert_mid: 13.5, mon_high: 7.5, recert_high: 15.0 },
  { emp_min: 3451, emp_max: 4350, mon_low: 6.0, recert_low: 12.0, mon_mid: 7.0, recert_mid: 14.0, mon_high: 8.0, recert_high: 15.5 },
  { emp_min: 4351, emp_max: 5450, mon_low: 6.5, recert_low: 13.0, mon_mid: 7.5, recert_mid: 15.0, mon_high: 8.0, recert_high: 16.0 },
  { emp_min: 5451, emp_max: 6800, mon_low: 7.0, recert_low: 14.0, mon_mid: 8.0, recert_mid: 16.0, mon_high: 9.0, recert_high: 17.5 },
  { emp_min: 6801, emp_max: 8500, mon_low: 8.0, recert_low: 16.0, mon_mid: 9.0, recert_mid: 17.5, mon_high: 9.5, recert_high: 19.0 },
  { emp_min: 8501, emp_max: 10700, mon_low: 8.5, recert_low: 17.0, mon_mid: 9.5, recert_mid: 19.0, mon_high: 10.0, recert_high: 20.0 },
];